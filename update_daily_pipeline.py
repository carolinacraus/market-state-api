...
def update_pipeline(start_date=None, end_date=None):
    ...
    try:
        ...
        logger.error(f"Error calculating or saving indicators: {e}")
        return
    finally:
    ...
    try:
        ...
        logger.error(f"Failed to classify market states: {e}")
